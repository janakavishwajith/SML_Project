 ...
 * 
 */
@WebServiceClient(name = "SMLServiceService", targetNamespace = "http://service.sml.code.mcs", wsdlLocation = "file:/E:/mphil_project/SMLService/WebServicesJaxWs/wsdl/SMLServiceService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "file:/E:/mphil_project/SMLService/WebServicesJaxWs/wsdl/SMLServiceService.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/E:/mphil_project/SMLService/WebServicesJaxWs/wsdl/SMLServiceService.wsdl', retrying as a local file");
